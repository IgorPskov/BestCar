# Generated by Django 4.2.7 on 2024-05-08 09:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_price', models.TextField(blank=True, null=True, verbose_name='Стоимость доставки')),
                ('requires_installment', models.BooleanField(default=False, verbose_name='Требуется кредит')),
                ('installment', models.BooleanField(blank=True, default=False, null=True, verbose_name='Вариант кредита')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='cars.products', verbose_name='Продукт')),
            ],
            options={
